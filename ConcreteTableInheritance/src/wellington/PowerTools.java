...
public enum PowerTools {
	 ...
	 *
	 */
	HITACHI_PNEUMATIC_NAILER("1231231234", 13, 39900, "Pheumatic Nail Gun", false),
	/**
	 *
	 */
	 ...
	 *
	 */
	TEN_INCH_TABLE_SAW("7657896543", 24, 39654, "Standard 10 inch table saw", false),
	/**
	 *
	 */
	TEN_INCH_PORTABLE_TABLE_SAW("9993458585", 13, 55555, "Portable 10 inch table saw", false),
	/**
	 *
	 */
	...
	private PowerTools(String upc, int manufacturerID, int price, String description, boolean batteryPowered) {
		this.upc = upc;
